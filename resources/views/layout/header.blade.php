                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownNotification">
                    ...
                    <li>
                      <a class="dropdown-item" href="#">
                        ...
                        <span class="small text-muted d-block">2 min ago</span>
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="#">
                        <i class="bx bx-user-plus me-2"></i> New user registered
                        <span class="small text-muted d-block">10 min ago</span>
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="#">
                        <i class="bx bx-error me-2"></i> System alert
                        <span class="small text-muted d-block">1 hr ago</span>
                      </a>
                    </li>
